 ...
 * @since 3/29/2007
 */
public class LibraryManagerLogin extends AbstractLoginDialog
{
   ...
   public LibraryManagerLogin()
   {
      ...
      logoPanel.add(new JLabel("<html><center><FONT color=blue>"
            + ContextManager.getSplashTitle() + "</B></FONT></center>", JLabel.CENTER));
      logoPanel.add(new JLabel(new ImageIcon(this.getClass().getResource(
            "images/" + ContextManager.getImagePrefix() + ".gif"))));
