 ...
 * @since 1/26/2007
 */
public class MembersManagerLogin extends AbstractLoginDialog
{
   private JLabel userLabel = new JLabel("Username: ", SwingConstants.RIGHT);
   ...
   public MembersManagerLogin()
   {
      Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
      setBounds(screenSize.width / 2 - 75, screenSize.height / 2 - 125, 350,
            300);
      ...
      logoPanel.add(new JLabel("<html><center><FONT color=blue><B>Tzu-Chi<br>"
            + "Members Manager" + "</B></FONT></center>", JLabel.CENTER));
      ...
      Border innerBorder = new TitledBorder(new EtchedBorder(), 
               " Log into Manager ", TitledBorder.LEFT, TitledBorder.TOP);
